...
query = ['select * from `essence-analytics-dwh.rtf.rtf_STAGE_google_fi_VIEW`', 'select * from `essence-analytics-dwh.rtf.rtf_STAGE_google_fi_device_fires_VIEW`', 'select * from `essence-analytics-dwh.rtf.rtf_STAGE_google_fi_week_deltas_VIEW`']
destination =['rtf_google_fi_PROD_datastudio_FINAL','rtf_google_fi_PROD_datastudio_device_fires_FINAL','rtf_google_fi_PROD_datastudio_week_deltas_FINAL']
...
def staging_to_prod(**kwargs):
    ...
    table_ref = client.dataset("rtf").table(kwargs['destination'])
