...
destination=['rtf_google_fi.Bing_SEM_Data', 'rtf_google_fi.Brand_SEM_Data','rtf_google_fi.BVOS_Data','rtf_google_fi.GDN_Data','rtf_google_fi.Google_SEM_Data','rtf_google_fi.Non_Brand_SEM_Data','rtf_google_fi.Yahoo_Data','rtf_google_fi.Youtube_Data', 'rtf_google_fi.Device_SEM', 'rtf_google_fi.Device_GDN', 'rtf_google_fi.Device_Youtube', 'rtf_google_fi.Device_All', 'rtf_google_fi.Keyword_CPA','rtf_google_fi.Reddit_Data']
...
# Define the DAG
dag = DAG('rtf_PROD_google_fi_refresh_from_gSheet_FINAL', description='Refreshes Google Fi Data From gSheets',
