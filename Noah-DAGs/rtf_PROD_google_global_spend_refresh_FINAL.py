...
def refreshGeneric(**kwargs):
    ...
    SCOPE_TABLE='google_cross_all_campaigns' #scope table example is Global_Goals.Consolidate.
    ...
    uri = "gs://sixty-analytics/rtf_google_cross_all_campaigns.csv"
    load_job = client.load_table_from_uri(
        uri, dataset_ref.table('google_cross_all_campaigns'),  job_config=job_config
    )  # API request
...
# Define the DAG
dag = DAG('rtf_PROD_google_global_spend_refresh_FINAL', description='Refreshes Google Global Spend Data From Looker -> GCS To BQ',
          default_args=def_args,
          schedule_interval= "0 6 9 1-12 *",
