...
SELECT 'Facebook' as Channel, Week , NULL as Date, Spend, Impressions, Link_Clicks as Clicks, NULL as Leads, NULL as Log_In, NULL as Email FROM `essence-analytics-dwh.rtf.FBv2`
)
select *, 

(CASE WHEN Channel = 'Google SEM' THEN Spend * .01 WHEN Channel = 'GDN' THEN Spend * 0.68 WHEN Channel = 'PLA' THEN Spend * 0.72 ELSE Spend  END) as Discounted_Spend,
